...
class NSM_Service_Query{

	/**
	 * The args to pass to the nsm_get_services() query
	 *
	 * @var array
	 * @since 1.0.0
	 */
	...
	/**
	 * The services found based on the criteria set
	 *
	 * @var array
	 * @since 1.0.0
	 */
	...
	public function __construct( $args = array() ){
		...
		if( isset( $GLOBALS['wp_query'] ) && isset( $GLOBALS['wp_query']->query ) && is_post_type_archive( 'service' ) ){
	...
	public function get_services() {
		...
		if ( $query->have_posts() ) {
			...
			$this->services['max_num_pages'] = $query->max_num_pages;
			$this->services['found_posts'] 	 = $query->found_posts;
		}
