...
class NSM_Testimonial_Query{

	/**
	 * The args to pass to the nsm_get_testimonials() query
	 *
	 * @var array
	 * @since 1.0.0
	 */
	...
	/**
	 * The testimonials found based on the criteria set
	 *
	 * @var array
	 * @since 1.0.0
	 */
	...
	public function __construct( $args = array() ){
		...
		if( isset( $GLOBALS['wp_query'] ) && isset( $GLOBALS['wp_query']->query ) && is_post_type_archive( 'testimonial' ) ){
	...
	public function get_testimonials() {
		...
		if ( $query->have_posts() ) {
			while ( $query->have_posts() ) {
				...
				$this->testimonials['testimonials'][] = $testimonial;
			}
			$this->testimonials['max_num_pages'] = $query->max_num_pages;
			$this->testimonials['found_posts'] 	 = $query->found_posts;
		}
